...
if isfield( data, 'choice' )
  total_cues_chosen_in_last_20 = sum( logical( allCueChosen(snippet) ) );
end

fprintf( 'Ratio of:\n')
fprintf( 'InitTrial:TotTrial;   Overall = %0.3f; Last 20 trials = %0.3f\n',...
  total_initiated_trials/num_trials, initiated_in_last_20/numel(snippet) );
fprintf( 'FixAcq:FixInit;       Overall = %0.3f; Last 20 trials = %0.3f\n',...
  total_fixations/total_initiated_trials, fixations_in_last_20/initiated_in_last_20 );
if isfield( data, 'decision' )
  fprintf( 'FixHeld:FixInit;      Overall = %0.3f; Last 20 trials = %0.3f\n',...
    total_fixation_held/total_initiated_trials, fixation_held_in_last_20/initiated_in_last_20 );
end
if isfield( data, 'choice' )
  fprintf( 'CorChoice:FixInit;    Overall = %0.3f; Last 20 trials = %0.3f\n',...
    total_cues_chosen/total_initiated_trials, total_cues_chosen_in_last_20/initiated_in_last_20 );
end
